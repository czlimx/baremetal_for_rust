//! Controls write access to IMPLEMENTATION DEFINED registers in EL2, such 
...
impl Readable for Reg {
    type T = u64;
    type R = ACTLR_EL3::Register;
    sys_register_read_raw!(u64, "ACTLR_EL3", "x");
}

impl Writeable for Reg {
    type T = u64;
    type R = ACTLR_EL3::Register;
    sys_register_write_raw!(u64, "ACTLR_EL3", "x");
}
